...
var FilesController = Backbone.Controller.extend({
    initialize: function () {
        var t = this,
            filesCollection = this.filesCollection = new FilesCollection(),
            filesListView = this.filesListView = new FilesListView(),
            fileDropView = this.fileDropView = new FileDropView();
